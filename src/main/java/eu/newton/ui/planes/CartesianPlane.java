...
public class CartesianPlane extends Pane {
    ...
    public CartesianPlane(FunctionController functionController, double xLow, double xHi, double yLow, double yHi) {
        this(functionController, xLow, xHi, yLow, yHi, STD_TICK_DENSITY, STD_POINT_DENSITY);
    }

    /**
     * @param functionController    math functions controller
     ...
     */
    public CartesianPlane(FunctionController functionController, double xLow, double xHi, double yLow, double yHi, double axisTickDensity, int pointsDensity) {
    ...
    /**
     * Add a math function to be managed by the controller
     * @param f math function to be managed by the controller
     */
    public void addFunction(FooMathFunction f) {
        functionController.add(f);
    }
    ...
    public void plot() {
        ...
        for (FooMathFunction f : functionController.getFunctions()) {
            if (f != null) {
     ...
     * @return  true if it is vertical
     */
    private boolean isVertical(FooMathFunction f, double[] points) {
